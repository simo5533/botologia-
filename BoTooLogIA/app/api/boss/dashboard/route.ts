...
import { getDashboardData } from "@/lib/services/boss-service";
...
/**
 * GET /api/boss/dashboard — Données du tableau de bord BOSS (exclusif BOSS).
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return respondApiCatch(error, "GET /api/boss/dashboard");
  }
}

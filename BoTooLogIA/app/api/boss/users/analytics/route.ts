...
import { getUserAnalytics } from "@/lib/services/boss-service";
...
/**
 * GET /api/boss/users/analytics — Analytics des utilisateurs (exclusif BOSS).
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    await createAuditLog({
      action: "boss.users.analytics.view",
      resource: "boss",
      userId: auth.userId,
    ...
    return respondApiCatch(error, "GET /api/boss/users/analytics");
  }
}
